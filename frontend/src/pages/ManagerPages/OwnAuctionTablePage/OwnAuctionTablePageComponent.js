...
import './OwnAuctionTablePage.css'

const OwnAuctionTablePage = (props) => {
        ...
        <AppLayout>
            <div className="own-auction-table-page-wrapper">
                <Table
                    ...
                    bordered
                />
                <Button className="own-auction-table-button" type="primary"
                        onClick={handleAdd}> {t('text.add')} </Button>
            </div>
        </AppLayout>
    );
}
